...
#define AX_RX_CTL			0x0b
	...
	#define AX_RX_CTL_HA8B			0x0004		/* HW auto-added 8-bytes data when meet USB bulk in transfer boundary (1024/512/64)*/	
...
#define AX_MEDIUM_STATUS_MODE		0x22
	...
	#define AX_MEDIUM_JUMBOFME_EN		0x40
...
#else
	#define AX_RXCOE_DEF_CSUM		(AX_RXCOE_IPC  |  AX_RXCOE_TCP | \
						 AX_RXCOE_UDP)
#endif
